	...
	<div id="header">
		...
		<form method="post" action="join.home">
			<div id="con_form2">
				...
				<div>
					<label>비밀번호</label>
					<input type="password" name="pw" placeholder="내용을 입력해주세요" />
				</div>
				<div>
					<label>비밀번호 확인</label>
					<input type="password" name="pw_re" placeholder="내용을 입력해주세요" />
				</div>
				<div>
					<label>이름</label>
				...
				<div>
					<label>유입경로</label>
					<div id="inflow">
						<input type='checkbox' name='inflow_path' value='intro'><label>지인소개</label>
	              		<input type='checkbox' name='inflow_path' value='search'><label>인터넷 검색</label>
	              		<input type='checkbox' name='inflow_path' value='b/f'><label>블로그/카페</label>
	              		<input type='checkbox' name='inflow_path' value='community'><label>커뮤니티</label>
	              		<input type='checkbox' name='inflow_path' value='recommend'><label>학원생 추천</label>
	              		<input type='checkbox' name='inflow_path' value='ect'></label>
	              		<input type="text" name="ect_content" placeholder="기타" />
	              	</div>
				</div>
				<div>
					<label>약관동의</label> 
