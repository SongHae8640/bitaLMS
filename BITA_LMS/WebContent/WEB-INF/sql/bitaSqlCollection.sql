...
--User
<<<<<<< HEAD
SELECT u.user_Id AS user_id, password, u.name AS name, email, phone_number, belong, l.name AS lectureName, start_date,end_date,l.lecture_id AS lecture_id FROM user01 u JOIN lectureuser lu ON u.user_id = lu.user_id JOIN lecture l ON lu.lecture_id = l.lecture_id 
=======
