...
<<<<<<< HEAD
INSERT INTO lecture(lecture_id,name,start_date,end_date,total_days,num_std,max_std,lv,content,is_close) values(1,'JAVA',TO_DATE('2019-06-01','YYYY-MM-DD'),TO_DATE('2019-08-30','YYYY-MM-DD'),60,0,30,3,'content','0');
INSERT INTO lecture(lecture_id,name,start_date,end_date,total_days,num_std,max_std,lv,content,is_close) values(2,'DB',TO_DATE('2019-07-01','YYYY-MM-DD'),TO_DATE('2019-09-30','YYYY-MM-DD'),60,0,30,3,'content','0');
INSERT INTO lecture(lecture_id,name,start_date,end_date,total_days,num_std,max_std,lv,content,is_close) values(3,'WEB',TO_DATE('2019-08-01','YYYY-MM-DD'),TO_DATE('2019-10-31','YYYY-MM-DD'),60,0,30,3,'content','0');
=======
...
--Teacher_info
<<<<<<< HEAD
INSERT INTO teacher_info(info_id,type ,content,teacher_id) VALUES(info_id_seq.nextval,'자격증','정보처리기사','tea1');
...
INSERT INTO attendance(day_time,std_id,checkin_time,checkout_time,status,lecture_id) VALUES(TO_DATE('20190703','YYYYMMDD'),'stu1',TO_DATE('20190703 09:00:11','YYYYMMDD HH24:MI:SS') ,TO_DATE('20190703 18:00:11','YYYYMMDD HH24:MI:SS') ,'결석',1);
...
<<<<<<< HEAD
INSERT INTO assignment(assignment_id, title, content, lecture_id, write_date) VALUES(assignment_id_seq.NEXTVAL,'과제1','과제1 내용을 이러하다.',1,SYSDATE);
INSERT INTO assignment(assignment_id, title, content, lecture_id, write_date) VALUES(assignment_id_seq.NEXTVAL,'과제2','과제2 내용이다.',1,SYSDATE);
INSERT INTO assignment(assignment_id, title, content, lecture_id, write_date) VALUES(assignment_id_seq.NEXTVAL,'과제2','과제3 내용',1,SYSDATE);
=======
...
--Submission
INSERT INTO submission(assignment_id, std_id,submit_date,is_check) VALUES(,'stu1',SYSDATE,'0');
...
<<<<<<< HEAD
INSERT INTO qna_l(qnal_id,std_id, type, title, question_content, answer_content, write_date, is_check) VALUES(qnal_id_seq.nextval,'stu1','의의신청','성적문의 입니다(제목)','성적이 잘못 나온것 같습니다. 수정 해주세요.','네 그게 맞습니다 더 공부하세요.',SYSDATE,1);
INSERT INTO qna_l(qnal_id,std_id, type, title, question_content, write_date, is_check) VALUES(qnal_id_seq.nextval,'stu2','성적문의','성적문의 입니다(제목)','성적이 잘못 나온것 같습니다. 수정 해주세요.',SYSDATE,0);
INSERT INTO qna_l(qnal_id,std_id, type, title, question_content, write_date, is_check) VALUES(qnal_id_seq.nextval,'stu3','강사','성적문의 입니다(제목)','성적이 잘못 나온것 같습니다. 수정 해주세요.',SYSDATE,0);
INSERT INTO qna_l(qnal_id,std_id, type, title, question_content, answer_content, write_date, is_check) VALUES(qnal_id_seq.nextval,'stu1','행정','공결 처리 문의 입니다.','~~~ 맞나요?','0000 입니다.',SYSDATE,1);
=======
